...
//                     onClick={(e) => {
//                       e.stopPropagation();
//                       //   setValue("genreIds", [...selectedOptionsIds, option.id]);
//                       setValue(
//                         "genreIds",
//                         selectedOptionsIds.filter((id) => id !== option.id)
//                       );
//                       setSelectedOptions((currState) =>
//                         currState.filter((o) => o.id !== option.id)
//                       );
//                     }}
//                   >
//                     <IoMdClose />
...
//       </div>
//       {optionsTabIsOpen && (
//         <div className="h-[200px] overflow-auto bg-project-light-blue rounded absolute -bottom-2 w-full translate-y-full flex flex-col ">
